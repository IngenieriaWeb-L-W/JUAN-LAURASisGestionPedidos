...
const modelsInfo = {
    ...
    Product: ["id", "title", "description", "price", "image", "createdAt", "updatedAt", "categoryId"],
    Rating: ["id", "rate", "count", "createdAt", "updatedAt", "productId"],
...
const outputsInfo = {
    ...
    ProductGroupBy: ["id", "title", "description", "price", "image", "createdAt", "updatedAt", "categoryId", "_count", "_avg", "_sum", "_min", "_max"],
    AggregateRating: ["_count", "_avg", "_sum", "_min", "_max"],
    RatingGroupBy: ["id", "rate", "count", "createdAt", "updatedAt", "productId", "_count", "_avg", "_sum", "_min", "_max"],
    ...
    ProductCountAggregate: ["id", "title", "description", "price", "image", "createdAt", "updatedAt", "categoryId", "_all"],
    ProductAvgAggregate: ["price"],
    ProductSumAggregate: ["price"],
    ProductMinAggregate: ["id", "title", "description", "price", "image", "createdAt", "updatedAt", "categoryId"],
    ProductMaxAggregate: ["id", "title", "description", "price", "image", "createdAt", "updatedAt", "categoryId"],
    RatingCountAggregate: ["id", "rate", "count", "createdAt", "updatedAt", "productId", "_all"],
    RatingAvgAggregate: ["rate", "count"],
    RatingSumAggregate: ["rate", "count"],
    RatingMinAggregate: ["id", "rate", "count", "createdAt", "updatedAt", "productId"],
    RatingMaxAggregate: ["id", "rate", "count", "createdAt", "updatedAt", "productId"],
    ...
    CreateManyUserAndReturnOutputType: ["id", "name", "email", "emailVerified", "image", "createdAt", "updatedAt"],
    CreateManyProductAndReturnOutputType: ["id", "title", "description", "price", "image", "createdAt", "updatedAt", "categoryId", "category"],
    CreateManyRatingAndReturnOutputType: ["id", "rate", "count", "createdAt", "updatedAt", "productId", "product"],
...
const inputsInfo = {
    ...
    ProductWhereInput: ["AND", "OR", "NOT", "id", "title", "description", "price", "image", "createdAt", "updatedAt", "categoryId", "rating", "category"],
    ProductOrderByWithRelationInput: ["id", "title", "description", "price", "image", "createdAt", "updatedAt", "categoryId", "rating", "category"],
    ProductWhereUniqueInput: ["id", "AND", "OR", "NOT", "title", "description", "price", "image", "createdAt", "updatedAt", "categoryId", "rating", "category"],
    ProductOrderByWithAggregationInput: ["id", "title", "description", "price", "image", "createdAt", "updatedAt", "categoryId", "_count", "_avg", "_max", "_min", "_sum"],
    ProductScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "title", "description", "price", "image", "createdAt", "updatedAt", "categoryId"],
    RatingWhereInput: ["AND", "OR", "NOT", "id", "rate", "count", "createdAt", "updatedAt", "productId", "product"],
    RatingOrderByWithRelationInput: ["id", "rate", "count", "createdAt", "updatedAt", "productId", "product"],
    RatingWhereUniqueInput: ["id", "productId", "AND", "OR", "NOT", "rate", "count", "createdAt", "updatedAt", "product"],
    RatingOrderByWithAggregationInput: ["id", "rate", "count", "createdAt", "updatedAt", "productId", "_count", "_avg", "_max", "_min", "_sum"],
    RatingScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "rate", "count", "createdAt", "updatedAt", "productId"],
    ...
    ProductCreateManyInput: ["id", "title", "description", "price", "image", "createdAt", "updatedAt", "categoryId"],
    ...
    RatingCreateManyInput: ["id", "rate", "count", "createdAt", "updatedAt", "productId"],
    ...
    ProductCountOrderByAggregateInput: ["id", "title", "description", "price", "image", "createdAt", "updatedAt", "categoryId"],
    ProductAvgOrderByAggregateInput: ["price"],
    ProductMaxOrderByAggregateInput: ["id", "title", "description", "price", "image", "createdAt", "updatedAt", "categoryId"],
    ProductMinOrderByAggregateInput: ["id", "title", "description", "price", "image", "createdAt", "updatedAt", "categoryId"],
    ProductSumOrderByAggregateInput: ["price"],
    FloatWithAggregatesFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not", "_count", "_avg", "_sum", "_min", "_max"],
    IntFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not"],
    ProductRelationFilter: ["is", "isNot"],
    RatingCountOrderByAggregateInput: ["id", "rate", "count", "createdAt", "updatedAt", "productId"],
    RatingAvgOrderByAggregateInput: ["rate", "count"],
    RatingMaxOrderByAggregateInput: ["id", "rate", "count", "createdAt", "updatedAt", "productId"],
    RatingMinOrderByAggregateInput: ["id", "rate", "count", "createdAt", "updatedAt", "productId"],
    ...
    ProductScalarWhereInput: ["AND", "OR", "NOT", "id", "title", "description", "price", "image", "createdAt", "updatedAt", "categoryId"],
